...
echo "      2. Pull Docker image: cd $REPO_DIR && ./scripts/devtools.py login && ./scripts/devtools.py pull_docker <tag>"
echo "      3. Upload dataset:    gsutil cp gs://<bucket>/<file>.h5 $STABLEWM_HOME/"
echo "      4. Start training:    cd $REPO_DIR && ./scripts/devtools.py run_local <tag> --data tworoom --setup cloud_a10g"
