...
(horizon, episode) lands in each cell.
    ...
    python "analysis/path_trajectories/viz_panel_grid.py" \
        --out "analysis/path_trajectories/runs/figures/horizon_2x2.png"
"""
...
RUN = "analysis/path_trajectories/runs"   # relative to repo-root cwd
